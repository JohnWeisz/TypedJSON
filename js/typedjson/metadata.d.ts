...
export declare class JsonMemberMetadata {
...
export declare class JsonObjectMetadata {
     ...
     */
    static getFromConstructor(target: Object | Function): JsonObjectMetadata;
    /**
     * Gets jsonObject metadata information from a class instance.
     * @param target The target instance.
     */
    static getFromInstance(target: any): JsonObjectMetadata;
    /**
