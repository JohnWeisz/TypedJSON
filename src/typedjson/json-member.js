...
function jsonMember(optionsOrTarget, propKey) {
    if (optionsOrTarget instanceof Object && (typeof propKey === "string" || typeof propKey === "symbol")) {
        ...
        if (Helpers.isReflectMetadataSupported) {
            ...
            var memberMetadata = new metadata_1.JsonMemberMetadata();
            if (!reflectPropCtor) {
            ...
            metadata_1.injectMetadataInformation(target, propKey, memberMetadata);
        }
        else {
        ...
        return function (target, _propKey) {
            ...
            var propCtor;
            var decoratorName = "@jsonMember on " + helpers_1.nameof(target.constructor) + "." + _propKey; // For error messages.
            ...
            metadata_1.injectMetadataInformation(target, _propKey, memberMetadata);
        };
    }
}
